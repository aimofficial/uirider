...
-keep public class com.newtaxiprime.user.appcommon.helper.** {
     public protected *;
}

-keep class com.newtaxiprime.user.taxiapp.views.firebaseChat.FirebaseChatModelClass{ *; }

-keep class com.newtaxiprime.user.taxiapp.views.main.MainActivity{ *; }
-keep class com.newtaxiprime.user.appcommon.datamodels.**{ *; }
-keep class com.newtaxiprime.user.taxiapp.datamodels.**{ *; }
-keep class com.newtaxiprime.user.appcommon.map.**{ *; }

-keep class com.newtaxiprime.user.taxiapp.views.voip.NewTaxiSinchService{ *; }
#}
