package com.newtaxiprime.user.taxiapp.singledateandtimepicker.widget;
...
import static com.newtaxiprime.user.taxiapp.singledateandtimepicker.DateHelper.getHour;
import static com.newtaxiprime.user.taxiapp.singledateandtimepicker.DateHelper.today;
import static com.newtaxiprime.user.taxiapp.singledateandtimepicker.widget.SingleDateAndTimeConstants.*;
import static com.newtaxiprime.user.taxiapp.singledateandtimepicker.widget.SingleDateAndTimeConstants.MAX_HOUR_DEFAULT;
import static com.newtaxiprime.user.taxiapp.singledateandtimepicker.widget.SingleDateAndTimeConstants.MIN_HOUR_DEFAULT;
