...
interface ApiService {
    ...
    // Get Banners
    @GET("get_banners")
    fun getBanners(@QueryMap hashMap: HashMap<String, String>): Call<ResponseBody>
    // Get Driver details
    ...
    // Transfer Money
    //@GET("transfer_money")
    //fun transferMoney(@Query("account_number") accountgettext: String, @Query("amount") amountgettext: String,@Query("token") token: String): Call<ResponseBody>
    @FormUrlEncoded
    @POST("transfer_money")
    fun transferMoney(@FieldMap walletParams: LinkedHashMap<String, String>): Call<ResponseBody>
