...
class PaytmPaymentWebViewActivity : CommonActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        commonMethods.setheaderText(resources.getString(R.string.paytm),  binding.commonHeader.tvHeadertext)
        ...
        val postData = "amount=" + URLEncoder.encode(payableWalletAmount, "UTF-8") + "&pay_for=" + URLEncoder.encode(payFor, "UTF-8") + "&payment_type=" + URLEncoder.encode(sessionManager.paymentMethod?.lowercase(), "UTF-8") + "&trip_id=" + URLEncoder.encode(sessionManager.tripId, "UTF-8")+ "&mode=" + URLEncoder.encode("light", "UTF-8") + "&token=" + URLEncoder.encode(sessionManager.accessToken, "UTF-8")
