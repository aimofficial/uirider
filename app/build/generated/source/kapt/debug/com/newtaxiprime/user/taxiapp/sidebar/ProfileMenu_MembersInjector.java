...
public final class ProfileMenu_MembersInjector implements MembersInjector<ProfileMenu> {
  ...
  public ProfileMenu_MembersInjector(Provider<SessionManager> localProvider,
  ...
  public static MembersInjector<ProfileMenu> create(Provider<SessionManager> localProvider,
      Provider<SessionManager> sessionManagerProvider,
      Provider<CommonMethods> commonMethodsProvider, Provider<ApiService> apiServiceProvider,
      Provider<CustomDialog> customDialogProvider, Provider<Gson> gsonProvider,
      Provider<UserChoice> userChoiceProvider) {
    return new ProfileMenu_MembersInjector(localProvider, sessionManagerProvider, commonMethodsProvider, apiServiceProvider, customDialogProvider, gsonProvider, userChoiceProvider);
  }

  public static MembersInjector<ProfileMenu> create(
  ...
  @InjectedFieldSignature("com.newtaxiprime.user.taxiapp.sidebar.ProfileMenu.sessionManager")
  public static void injectSessionManager(ProfileMenu instance, SessionManager sessionManager) {
    instance.sessionManager = sessionManager;
  }

  @InjectedFieldSignature("com.newtaxiprime.user.taxiapp.sidebar.ProfileMenu.commonMethods")
  public static void injectCommonMethods(ProfileMenu instance, CommonMethods commonMethods) {
    instance.commonMethods = commonMethods;
  }

  @InjectedFieldSignature("com.newtaxiprime.user.taxiapp.sidebar.ProfileMenu.apiService")
  public static void injectApiService(ProfileMenu instance, ApiService apiService) {
    instance.apiService = apiService;
  }

  @InjectedFieldSignature("com.newtaxiprime.user.taxiapp.sidebar.ProfileMenu.customDialog")
  public static void injectCustomDialog(ProfileMenu instance, CustomDialog customDialog) {
    instance.customDialog = customDialog;
  }

  @InjectedFieldSignature("com.newtaxiprime.user.taxiapp.sidebar.ProfileMenu.gson")
  public static void injectGson(ProfileMenu instance, Gson gson) {
    instance.gson = gson;
  }

  @InjectedFieldSignature("com.newtaxiprime.user.taxiapp.sidebar.ProfileMenu.userChoice")
  public static void injectUserChoice(ProfileMenu instance, UserChoice userChoice) {
