...
public final class SendingRequestActivity_MembersInjector implements MembersInjector<SendingRequestActivity> {
  ...
  public SendingRequestActivity_MembersInjector(Provider<SessionManager> localProvider,
  ...
  public static MembersInjector<SendingRequestActivity> create(
      Provider<SessionManager> localProvider, Provider<SessionManager> sessionManagerProvider,
      Provider<CommonMethods> commonMethodsProvider, Provider<ApiService> apiServiceProvider,
      Provider<CustomDialog> customDialogProvider, Provider<Gson> gsonProvider) {
    return new SendingRequestActivity_MembersInjector(localProvider, sessionManagerProvider, commonMethodsProvider, apiServiceProvider, customDialogProvider, gsonProvider);
  }
  ...
  public static MembersInjector<SendingRequestActivity> create(
    ...
    return new SendingRequestActivity_MembersInjector(Providers.asDaggerProvider(localProvider), Providers.asDaggerProvider(sessionManagerProvider), Providers.asDaggerProvider(commonMethodsProvider), Providers.asDaggerProvider(apiServiceProvider), Providers.asDaggerProvider(customDialogProvider), Providers.asDaggerProvider(gsonProvider));
  }

  @Override
  public void injectMembers(SendingRequestActivity instance) {
  ...
  @InjectedFieldSignature("com.newtaxiprime.user.taxiapp.sendrequest.SendingRequestActivity.sessionManager")
  public static void injectSessionManager(SendingRequestActivity instance,
      SessionManager sessionManager) {
    instance.sessionManager = sessionManager;
  }

  @InjectedFieldSignature("com.newtaxiprime.user.taxiapp.sendrequest.SendingRequestActivity.commonMethods")
  public static void injectCommonMethods(SendingRequestActivity instance,
      CommonMethods commonMethods) {
    instance.commonMethods = commonMethods;
  }

  @InjectedFieldSignature("com.newtaxiprime.user.taxiapp.sendrequest.SendingRequestActivity.apiService")
  public static void injectApiService(SendingRequestActivity instance, ApiService apiService) {
    instance.apiService = apiService;
  }

  @InjectedFieldSignature("com.newtaxiprime.user.taxiapp.sendrequest.SendingRequestActivity.customDialog")
  public static void injectCustomDialog(SendingRequestActivity instance,
      CustomDialog customDialog) {
    instance.customDialog = customDialog;
  }

  @InjectedFieldSignature("com.newtaxiprime.user.taxiapp.sendrequest.SendingRequestActivity.gson")
  public static void injectGson(SendingRequestActivity instance, Gson gson) {
    instance.gson = gson;
  }
}
