...
public final class PaymentPage_MembersInjector implements MembersInjector<PaymentPage> {
  ...
  public PaymentPage_MembersInjector(Provider<SessionManager> localProvider,
  ...
  public static MembersInjector<PaymentPage> create(Provider<SessionManager> localProvider,
      Provider<SessionManager> sessionManagerProvider,
      Provider<CommonMethods> commonMethodsProvider, Provider<ApiService> apiServiceProvider,
      Provider<CustomDialog> customDialogProvider, Provider<Gson> gsonProvider) {
    return new PaymentPage_MembersInjector(localProvider, sessionManagerProvider, commonMethodsProvider, apiServiceProvider, customDialogProvider, gsonProvider);
  }

  public static MembersInjector<PaymentPage> create(
  ...
  @InjectedFieldSignature("com.newtaxiprime.user.taxiapp.sidebar.payment.PaymentPage.sessionManager")
  public static void injectSessionManager(PaymentPage instance, SessionManager sessionManager) {
    instance.sessionManager = sessionManager;
  }

  @InjectedFieldSignature("com.newtaxiprime.user.taxiapp.sidebar.payment.PaymentPage.commonMethods")
  public static void injectCommonMethods(PaymentPage instance, CommonMethods commonMethods) {
    instance.commonMethods = commonMethods;
  }

  @InjectedFieldSignature("com.newtaxiprime.user.taxiapp.sidebar.payment.PaymentPage.apiService")
  public static void injectApiService(PaymentPage instance, ApiService apiService) {
    instance.apiService = apiService;
  }

  @InjectedFieldSignature("com.newtaxiprime.user.taxiapp.sidebar.payment.PaymentPage.customDialog")
  public static void injectCustomDialog(PaymentPage instance, CustomDialog customDialog) {
    instance.customDialog = customDialog;
  }

  @InjectedFieldSignature("com.newtaxiprime.user.taxiapp.sidebar.payment.PaymentPage.gson")
  public static void injectGson(PaymentPage instance, Gson gson) {
    instance.gson = gson;
  }
}
