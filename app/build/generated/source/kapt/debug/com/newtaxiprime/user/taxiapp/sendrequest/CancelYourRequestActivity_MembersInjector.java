...
public final class CancelYourRequestActivity_MembersInjector implements MembersInjector<CancelYourRequestActivity> {
  ...
  public CancelYourRequestActivity_MembersInjector(Provider<SessionManager> localProvider,
  ...
  public static MembersInjector<CancelYourRequestActivity> create(
      Provider<SessionManager> localProvider, Provider<SessionManager> sessionManagerProvider,
      Provider<CommonMethods> commonMethodsProvider, Provider<ApiService> apiServiceProvider,
      Provider<CustomDialog> customDialogProvider, Provider<Gson> gsonProvider) {
    return new CancelYourRequestActivity_MembersInjector(localProvider, sessionManagerProvider, commonMethodsProvider, apiServiceProvider, customDialogProvider, gsonProvider);
  }
  ...
  @InjectedFieldSignature("com.newtaxiprime.user.taxiapp.sendrequest.CancelYourRequestActivity.sessionManager")
  public static void injectSessionManager(CancelYourRequestActivity instance,
      SessionManager sessionManager) {
    instance.sessionManager = sessionManager;
  }

  @InjectedFieldSignature("com.newtaxiprime.user.taxiapp.sendrequest.CancelYourRequestActivity.commonMethods")
  public static void injectCommonMethods(CancelYourRequestActivity instance,
      CommonMethods commonMethods) {
    instance.commonMethods = commonMethods;
  }

  @InjectedFieldSignature("com.newtaxiprime.user.taxiapp.sendrequest.CancelYourRequestActivity.apiService")
  public static void injectApiService(CancelYourRequestActivity instance, ApiService apiService) {
    instance.apiService = apiService;
  }

  @InjectedFieldSignature("com.newtaxiprime.user.taxiapp.sendrequest.CancelYourRequestActivity.customDialog")
  public static void injectCustomDialog(CancelYourRequestActivity instance,
      CustomDialog customDialog) {
    instance.customDialog = customDialog;
  }

  @InjectedFieldSignature("com.newtaxiprime.user.taxiapp.sendrequest.CancelYourRequestActivity.gson")
  public static void injectGson(CancelYourRequestActivity instance, Gson gson) {
    instance.gson = gson;
  }
}
