...
public final class PrivacyPolicyBinding implements ViewBinding {
  ...
  private PrivacyPolicyBinding(@NonNull ConstraintLayout rootView, @NonNull WebView webView) {
  ...
  public static PrivacyPolicyBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new PrivacyPolicyBinding((ConstraintLayout) rootView, webView);
    }
